	...
	.file	"asm-offsets.c"
@ GNU C (Ubuntu/Linaro 4.9.2-0ubuntu1~14.04) version 4.9.2 (arm-linux-gnueabihf)
@	compiled by GNU C version 4.9.2, GMP version 5.1.3, MPFR version 3.1.2-p3, MPC version 1.0.1
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -fpreprocessed /tmp/distccd_8b1b2e8e.i -mlittle-endian
...
@ -auxbase-strip /tmp/distccd_8b3a2e8e.o -O2 -Wall -Wundef
...
@ 0 "" 2
	...
	ldmfd	sp, {fp, sp, pc}	@
	.size	main, .-main
	.ident	"GCC: (Ubuntu/Linaro 4.9.2-0ubuntu1~14.04) 4.9.2"
